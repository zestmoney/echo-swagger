...
```sh_ "github.com/RobinSinghS/echo-swagger/v2/example/docs"
$ swag init
```
...
import (
	...
	_ "github.com/RobinSinghS/echo-swagger/example/docs" // docs is generated by Swag CLI, you have to import it.
)
